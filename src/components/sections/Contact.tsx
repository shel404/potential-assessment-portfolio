    ...
    >
      ...
      >
        <input
          ...
          className="flex-1 px-6 py-4 rounded-lg bg-gray-50  border border-gray-200 dark:border-black-600 focus:outline-none focus:border-orange-500 text-black-900 "
          required
        />
        <button
          type="submit"
